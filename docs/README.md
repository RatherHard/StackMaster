...
| [宿主平台接入指南.md](user/宿主平台接入指南.md) | 宿主平台 | 架构分工(嵌入协议只承载控制面)、插件文档页部署、embed token 与引导配置端点(通道 a / b)、embed-runtime SDK 用法、宿主校验义务速查(V-1~V-13 人话版)、能力与外观(terminal 承载口径 D-MP-2)、成绩边界 |
