...
| [出题人参考手册.html](user/出题人参考手册.html) | 出题人(深度参考) | 单文件网页手册:快速开始、文件清单、公开/私有包逐字段参考(约束摘自 Schema 原文)、20 opcode 与字节模式、自定义指令/作者接口、判题面与隐藏测试、stages/seed/预算、34+18 条校验规则速查、四个完整出题实例、测试与发布模板、发布前检查清单 |
